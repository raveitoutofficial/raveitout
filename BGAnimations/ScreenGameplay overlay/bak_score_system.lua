...
t[#t+1] = CustomScore(PLAYER_1)..{
    InitCommand=cmd(x,THEME:GetMetric("ScreenGameplay","PlayerP1OnePlayerOneSideX");y,SCREEN_BOTTOM-46;horizalign,CENTER);
};

t[#t+1] = CustomScore(PLAYER_2)..{
    InitCommand=cmd(x,THEME:GetMetric("ScreenGameplay","PlayerP2OnePlayerOneSideX");y,SCREEN_BOTTOM-46;horizalign,CENTER);
};
