...
Def.ActorFrame{
	...
	LoadFont("monsterrat/_montserrat light 60px")..{	
		InitCommand=cmd(horizalign,center;x,SCREEN_CENTER_X;y,SCREEN_TOP+10;zoom,0.35;skewx,-0.15);
...
LoadActor("songartist_name")..{
	InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_BOTTOM-50;diffusealpha,1;zoomto,600,15);
};
...
LoadActor(THEME:GetPathG("","PlayModes/splash/Arcade"))..{
		...
		OffCommand=cmd(diffusealpha,1;Center;zoomto,SCREEN_WIDTH,SCREEN_HEIGHT);
	};
};
--[[
--left
